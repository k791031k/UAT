/**
 * ============================================================================
 * 商品代碼查詢工具 v7.0 - FINAL (穩定重構版)
 *
 * 架構師：Gemini (由 Google 開發)
 * 發佈日期：2025-06-23
 *
 * v7.0 更新日誌:
 * - 核心架構重構：採用更穩健的單一可拖曳視窗模型，解決所有執行與互動問題。
 * - UI 與事件修復：確保所有關閉按鈕、取消按鈕與 ESC 鍵都能正常運作。
 * - 完整實現所有已確認功能：包含七種查詢模式、查詢中斷、失敗重試與分頁。
 * - 全面優化程式碼結構與註解，提升可維護性。
 * ============================================================================
 */
javascript: (function() {
	...
	const UIManager = (function() {
		...
		function renderView({
			...
			ui.container.innerHTML = `
                ...
                <div class="pct-main-content">
                    <div class="pct-content-body">${bodyHTML}</div>
